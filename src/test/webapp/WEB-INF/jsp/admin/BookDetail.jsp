...
<fmt:setBundle basename="messages" var="msg" />
 <t:base> 
   <jsp:attribute name="script"> 
	...
	dataForm.action='/admin/Book/delete.htm';
	dataForm.submit();
} //end delete function
function updateClick(dataForm){
	dataForm.action='/admin/Book/save.htm';
	dataForm.submit();
} //end update function
...
<a href='/admin/Book/list.htm'>Back to List Menu</a></div>
<form id='dataFormId' name='dataForm' action ='/admin/Book/save.htm' METHOD='post'>
